...
class SeriesOfPosts{
    ...
    public function simple_display_series_of_posts($connection, $get, $session, $timeline_or_user){ // $timeline_or_user peut contenir soit : author_id soit : follower_id 
        ...
        $posts=$POST->simple_display_timeline_posts($connection, $session, $get, $order, $timeline_or_user); // accès aux postes

        $pages_drop_down_display= $this->display_drop_down_for_pages($connection, $session); // pour l'affichage de la liste déroulante
